...
const ListDishesCardView: React.FC<ListDishesCardProps> = ({
  ...
  const mockDishes = [
    ...
    },
    {
      ...
      description:
        'Lasanha tradicional com molho bolognesa, bechamel e queijo parmesão',
      price: 38.0,
      image:
    ...
    },
    {
      ...
      description:
        'Peixe fresco marinado em limão com cebola roxa, pimenta e coentro',
      price: 32.0,
      image:
    ...
    },
    {
      ...
      name: 'Pad Thai',
      description:
        'Macarrão de arroz salteado com camarão, amendoim, broto de feijão e molho tamarindo',
      price: 29.9,
      image:
    ...
    },
    {
      ...
      description:
        'Tortilla de farinha com carne, feijão, queijo, guacamole e salsa',
      price: 26.5,
      image:
        'https://images.unsplash.com/photo-1566740933430-b5e70b06d2d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
